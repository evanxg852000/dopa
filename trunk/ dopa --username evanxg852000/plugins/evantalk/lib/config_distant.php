...
// Database hostname:
$config['dbConnection']['host'] = 'sql3';
// Database username:
$config['dbConnection']['user'] = 'evansofts';
// Database password:
$config['dbConnection']['pass'] = 'ZNnCBB7C';
// Database name:
$config['dbConnection']['name'] = 'evansofts';
// Database type:
...
// Available languages:
$config['langAvailable'] = array('en','fr');
// Default language:
$config['langDefault'] = 'en';
// Language names:
$config['langNames'] = array('en'=>'English' ,'fr'=>'Français');

// Available styles:
$config['styleAvailable'] = array('Evansofts','Lune','Bricol','Jamac');
// Default style:
$config['styleDefault'] = 'Evansofts';
